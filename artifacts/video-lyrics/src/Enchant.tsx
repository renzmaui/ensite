...
<article className="stage-card">
  <div className="video-track-header">
    <span>
      {String(selectedTrack.number).padStart(2, "0")} | {selectedTrack.title}
    </span>

    <span className="video-track-type">
              ...
              <div className="lyrics-headline">
                <div>
                  <h2 className="lyrics-title">
                     Every word. Every chant. Right on cue.</h2>
                </div>
